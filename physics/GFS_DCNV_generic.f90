...
!! | upd_mfi         | instantaneous_atmosphere_updraft_convective_mass_flux_on_dynamics_timestep                  | (updraft mass flux) * delt                                           | kg m-2        |    2 | real              | kind_phys | inout  | F        |                                                                                          | instantaneous convective updraft mass flux           |               |    2 | real    | kind_phys | inout   | F        |
!! | dwn_mfi         | instantaneous_atmosphere_downdraft_convective_mass_flux_on_dynamics_timestep                | (downdraft mass flux) * delt                                         | kg m-2        |    2 | real              | kind_phys | inout  | F        |                                                                                          | instantaneous convective downdraft mass flux         |               |    2 | real    | kind_phys | inout  | F        |
!! | det_mfi         | instantaneous_atmosphere_detrainment_convective_mass_flux_on_dynamics_timestep              | (detrainment mass flux) * delt                                       | kg m-2        |    2 | real              | kind_phys | inout  | F        |                                                                                      | instantaneous convective detrainment mass flux       |               |    2 | real    | kind_phys | inout  | F        |
