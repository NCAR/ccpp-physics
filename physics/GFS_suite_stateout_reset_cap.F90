...
!>
!! @brief Auto-generated cap module for the GFS_suite_stateout_reset scheme
!!
!
module GFS_suite_stateout_reset_cap
    ...
    use            :: GFS_suite_stateout_reset, &
                      only: GFS_suite_stateout_reset_finalize,GFS_suite_stateout_reset_init,GFS_suite_stateout_reset_run
    ...
    private
    public :: GFS_suite_stateout_reset_finalize_cap,GFS_suite_stateout_reset_init_cap,GFS_suite_stateout_reset_run_cap

    contains


    function GFS_suite_stateout_reset_finalize_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_suite_stateout_reset_finalize()
        

    end function GFS_suite_stateout_reset_finalize_cap

    function GFS_suite_stateout_reset_init_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_suite_stateout_reset_init()
        

    end function GFS_suite_stateout_reset_init_cap

    function GFS_suite_stateout_reset_run_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_suite_stateout_reset_run(im=im,levs=levs,ntrac=ntrac,tgrs=tgrs,ugrs=ugrs,vgrs=vgrs,qgrs=qgrs,gt0=gt0, &
                  gu0=gu0,gv0=gv0,gq0=gq0,errmsg=cdata%errmsg,errflg=cdata%errflg)
        ierr=cdata%errflg

    end function GFS_suite_stateout_reset_run_cap
end module GFS_suite_stateout_reset_cap
