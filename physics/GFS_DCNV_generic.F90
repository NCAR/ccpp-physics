...
!!
#endif
    subroutine GFS_DCNV_generic_pre_run (im, levs, ldiag3d, qdiag3d, do_cnvgwd, do_ca, &
      ...
      logical, intent(in) :: ldiag3d, do_cnvgwd, do_ca, isppt_deep, qdiag3d
      ...
      if (( ldiag3d .and. qdiag3d) .or. isppt_deep) then
        do k=1,levs
          do i=1,im
