...
!!
      ...
      subroutine mp_thompson_hrrr_run(ncol, nlev, con_g, con_rd,         &
                              ...
                              rain, rainst, snow, ice, graupel, sr,      &
                              islmsk,                                    &
         ...
         if (is_aerosol_aware .and. .not. (present(nc) .and. present(nwfa) .and. present(nifa) .and. present(nwfa2d))) then
         ...
         if (is_aerosol_aware) then
            call mp_gt_driver(qv=qv_mp, qc=qc_mp, qr=qr_mp, qi=qi_mp, qs=qs_mp, qg=qg_mp,    &
                              ni=ni, nr=nr, nc=nc,                                           &
                              nwfa=nwfa, nifa=nifa, nwfa2d=nwfa2d,                           &
