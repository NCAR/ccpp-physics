...
!> \name Geophysics/Astronomy constants
  real(kind=kind_phys),parameter:: con_rerth  =6.3712e+6                 !< radius of earth (\f$m\f$)
  real(kind=kind_phys),parameter:: con_g      =9.80665e+0                !< gravity (\f$m/s^{2}\f$)
  real(kind=kind_phys),parameter:: con_omega  =7.2921e-5                 !< ang vel of earth (\f$s^{-1}\f$)
  real(kind=kind_phys),parameter:: con_p0     =1.01325e5                 !< standard atmospheric pressure (\f$Pa\f$)
...
!> \name Thermodynamics constants
  ...
  real(kind=kind_phys),parameter:: con_rd     =2.8705e+2                 !< gas constant air (\f$J/kg/K\f$)
  real(kind=kind_phys),parameter:: con_rv     =4.6150e+2                 !< gas constant H2O (\f$J/kg/K\f$)
  real(kind=kind_phys),parameter:: con_cp     =1.0046e+3                 !< spec heat air at p (\f$J/kg/K\f$)
  real(kind=kind_phys),parameter:: con_cv     =7.1760e+2                 !< spec heat air at v (\f$J/kg/K\f$)
  real(kind=kind_phys),parameter:: con_cvap   =1.8460e+3                 !< spec heat H2O gas (\f$J/kg/K\f$)
  real(kind=kind_phys),parameter:: con_cliq   =4.1855e+3                 !< spec heat H2O liq (\f$J/kg/K\f$)
  real(kind=kind_phys),parameter:: con_csol   =2.1060e+3                 !< spec heat H2O ice (\f$J/kg/K\f$)
  real(kind=kind_phys),parameter:: con_hvap   =2.5000e+6                 !< lat heat H2O cond (\f$J/kg\f$)
  real(kind=kind_phys),parameter:: con_hfus   =3.3358e+5                 !< lat heat H2O fusion (\f$J/kg\f$)
  real(kind=kind_phys),parameter:: con_psat   =6.1078e+2                 !< pres at H2O 3pt (\f$Pa\f$)
...
!> \name Other Physics/Chemistry constants (source: 2002 CODATA)
  real(kind=kind_phys),parameter:: con_c      =2.99792458e+8             !< speed of light (\f$m/s\f$)
  real(kind=kind_phys),parameter:: con_plnk   =6.6260693e-34             !< planck constant (\f$J/s\f$)
  real(kind=kind_phys),parameter:: con_boltz  =1.3806505e-23             !< boltzmann constant (\f$J/K\f$)
