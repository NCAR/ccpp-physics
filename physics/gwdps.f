...
!! | dusfc          | x_surface_stress_due_to_orographic_gravity_wave_drag                    | zonal surface stress due to orographic gravity wave drag                                      | Pa         | 1    | real    | kind_phys | out    | F        |
!! | dvsfc          | y_surface_stress_due_to_orographic_gravity_wave_drag                    | meridional surface stress due to orographic gravity wave drag                                 | Pa         | 1    | real    | kind_phys | out    | F        |
...
!! | dusfcg         | x_surface_stress_due_to_orographic_gravity_wave_drag                      | zonal surface stress due to orographic gravity wave drag                            | Pa        | 1    | real    | kind_phys | in     | F        |
!! | dvsfcg         | y_surface_stress_due_to_orographic_gravity_wave_drag                      | meridional surface stress due to orographic gravity wave drag                       | Pa        | 1    | real    | kind_phys | in     | F        |
!! | dudt           | tendency_of_x_wind_due_to_physics                                         | zonal wind tendency due to physics                                                  | m s-2     | 2    | real    | kind_phys | in     | F        |
!! | dvdt           | tendency_of_y_wind_due_to_physics                                         | meridional wind tendency due to physics                                             | m s-2     | 2    | real    | kind_phys | in     | F        |
!! | dtdt           | tendency_of_air_temperature_due_to_physics                                | air temperature tendency due to physics                                             | K s-1     | 2    | real    | kind_phys | in     | F        |
!! | dugwd  ??      | time_integral_of_x_surface_stress_due_to_orographic_gravity_wave_drag  ?? | integral over time of zonal surface stress due to orographic gravity wave drag      | Pa s  ??  | 2    | real    | kind_phys | inout  | F        |
!! | dvgwd  ??      | time_integral_of_y_surface_stress_due_to_orographic_gravity_wave_drag  ?? | integral over time of meridional surface stress due to orographic gravity wave drag | Pa s  ??  | 2    | real    | kind_phys | inout  | F        |
!! | du3dt  ??      | cumulative_change_in_x_wind_due_to_physics                                | cumulative change in zonal wind due to physics                                      | m s-1  ?? | 2    | real    | kind_phys | inout  | F        |
!! | dv3dt  ??      | cumulative_change_in_y_wind_due_to_physics                                | cumulative change in meridional wind due to physics                                 | m s-1  ?? | 2    | real    | kind_phys | inout  | F        |
!! | dt3dt  ??      | cumulative_change_in_temperature_due_to_physics                           | cumulative change in temperature due to physics                                     | K  ??     | 2    | real    | kind_phys | inout  | F        |
!!
      use machine, only : kind_phys
      implicit none
