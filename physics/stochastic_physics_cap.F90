...
!>
!! @brief Auto-generated cap module for the stochastic_physics scheme
!!
!
module stochastic_physics_cap
    ...
    use            :: stochastic_physics, &
                      only: stochastic_physics_finalize,stochastic_physics_init,stochastic_physics_run
    ...
    private
    public :: stochastic_physics_finalize_cap,stochastic_physics_init_cap,stochastic_physics_run_cap

    contains


    function stochastic_physics_finalize_cap(ptr) bind(c) result(ierr)
    ...
    end function stochastic_physics_finalize_cap

    function stochastic_physics_init_cap(ptr) bind(c) result(ierr)
        ...
        call stochastic_physics_init(Model=Model,nthreads=nthreads,errmsg=cdata%errmsg,errflg=cdata%errflg)
        ierr=cdata%errflg

    end function stochastic_physics_init_cap

    function stochastic_physics_run_cap(ptr) bind(c) result(ierr)
        ...
        call stochastic_physics_run(Model=Model,Data=Data,nthreads=nthreads,errmsg=cdata%errmsg,errflg=cdata%errflg)
        ierr=cdata%errflg

    end function stochastic_physics_run_cap
end module stochastic_physics_cap
