...
!! | prec       | precipitation_flux_at_surface                          | precipitation flux at surface (including snowfall)                                                    | kg m-2 s-1 |    1 | real      | kind_phys | out    | F        |
...
!! | ud_mf      | atmosphere_updraft_convective_mass_flux                | updraft mass flux                                                                                     | kg m-2 s-1 |    2 | real      | kind_phys | inout  | F        |
!! | dd_mf      | atmosphere_downdraft_convective_mass_flux              | downdraft mass flux                                                                                   | kg m-2 s-1 |    2 | real      | kind_phys | inout  | F        |
!! | dt_mf      | atmosphere_detrainment_convective_mass_flux            | detrainment mass flux                                                                                 | kg m-2 s-1 |    2 | real      | kind_phys | inout  | F        |
...
!! | sigma      | convective_updraft_area_fraction                       | convective updraft area fraction                                                                      | frac       |    2 | real      | kind_phys | out    | F        |
