...
!! @{
      subroutine GFS_phys_time_vary_init (                                                         &
         ...
         real(kind_phys),      intent(out) :: albdvis_lnd(:)
         real(kind_phys),      intent(out) :: albdnir_lnd(:)
         real(kind_phys),      intent(out) :: albivis_lnd(:)
         real(kind_phys),      intent(out) :: albinir_lnd(:)
         real(kind_phys),      intent(out) :: albdvis_ice(:)
         real(kind_phys),      intent(out) :: albdnir_ice(:)
         real(kind_phys),      intent(out) :: albivis_ice(:)
         real(kind_phys),      intent(out) :: albinir_ice(:)
         real(kind_phys),      intent(out) :: emiss_lnd(:)
         real(kind_phys),      intent(out) :: emiss_ice(:)
