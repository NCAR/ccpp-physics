...
!!
#endif
   subroutine GFS_surface_composites_pre_run (im, cplflx, landfrac, lakefrac, oceanfrac,             &
                       dry, icy, lake, ocean, wet, fice, cimin, zorl, zorlo, zorll, zorl_ocn,        &
                       ...
                       weasd_ice, ep1d_ice, tsfc, tsfco, tsfcl, tsfc_ocn, tsfc_lnd, tsfc_ice, tisfc, &
                       tsurf, tsurf_ocn, tsurf_lnd, tsurf_ice, errmsg, errflg)
      ...
      real(kind=kind_phys), dimension(im), intent(in)    :: zorl, snowd, tprcp, uustar, weasd, tsfc

      real(kind=kind_phys), dimension(im), intent(inout) :: zorlo, zorll, tsfco, tsfcl, tisfc, tsurf
...
!!
   ...
   subroutine GFS_surface_composites_post_run (                                                                                       &
      im, cplflx, flag_cice, dry, wet, icy, lndfrac, lakfrac, ocnfrac, cice, zorl, zorlo, zorll, zorl_ocn, zorl_lnd, zorl_ice,    &
      ...
      real(kind=kind_phys), dimension(im),  intent(in)  :: lndfrac, lakfrac, ocnfrac, cice,                                     &
