...
!>
!! @brief Auto-generated cap module for the GFS_interstitialtoscreen scheme
!!
!
module GFS_interstitialtoscreen_cap
    ...
    use            :: GFS_interstitialtoscreen, &
                      only: GFS_interstitialtoscreen_init,GFS_interstitialtoscreen_run,GFS_interstitialtoscreen_finalize
    ...
    private
    public :: GFS_interstitialtoscreen_init_cap,GFS_interstitialtoscreen_run_cap,GFS_interstitialtoscreen_finalize_cap

    contains


    function GFS_interstitialtoscreen_init_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_interstitialtoscreen_init()
        

    end function GFS_interstitialtoscreen_init_cap

    function GFS_interstitialtoscreen_run_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_interstitialtoscreen_run(Model=Model,Statein=Statein,Stateout=Stateout,Sfcprop=Sfcprop,Coupling=Coupling, &
    ...
    end function GFS_interstitialtoscreen_run_cap

    function GFS_interstitialtoscreen_finalize_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_interstitialtoscreen_finalize()
        

    end function GFS_interstitialtoscreen_finalize_cap
end module GFS_interstitialtoscreen_cap
