...
!! | cld_frac_MG    | cloud_fraction_for_MG                                 | cloud fraction used by Morrison-Gettelman MP                                                | frac    |    2 | real       | kind_phys | inout  | F        |
...
subroutine m_micro_pre_run (im, levs, do_shoc, imfdeepcnv, imfshalcnv, gq0_ice, gq0_water, cld_shoc, cnvc, cnvw, &
  tcr, tcrf, gt0, cld_frac_MG, qlcn, qicn, cf_upi, clw_water, clw_ice, errmsg, errflg )
...
!! | taux           | instantaneous_surface_x_momentum_flux                                       | x momentum flux                                                                             | Pa          |    1 | real       | kind_phys | in     | F        |
!! | tauy           | instantaneous_surface_y_momentum_flux                                       | y momentum flux                                                                             | Pa          |    1 | real       | kind_phys | in     | F        |
...
!! | rnw_io         | rain_water_mixing_ratio_updated_by_physics                                  | moist (dry+vapor, no condensates) mixing ratio of rain water updated by physics             | kg kg-1     |    2 | real       | kind_phys | inout  | F        |
!! | snw_io         | snow_water_mixing_ratio_updated_by_physics                                  | moist (dry+vapor, no condensates) mixing ratio of snow water updated by physics             | kg kg-1     |    2 | real       | kind_phys | inout  | F        |
!! | qgl_io         | graupel_mixing_ratio_updated_by_physics                                     | moist (dry+vapor, no condensates) mixing ratio of graupel updated by physics                | kg kg-1     |    2 | real       | kind_phys | inout  | F        |
!! | ncpr_io        | rain_number_concentration_updated_by_physics                                | number concentration of rain updated by physics                                             | kg-1        |    2 | real       | kind_phys | inout  | F        |
!! | ncps_io        | snow_number_concentration_updated_by_physics                                | number concentration of snow updated by physics                                             | kg-1        |    2 | real       | kind_phys | inout  | F        |
!! | ncgl_io        | graupel_number_concentration_updated_by_physics                             | number concentration of graupel updated by physics                                          | kg-1        |    2 | real       | kind_phys | inout  | F        |
...
!   Local variables
     ...
     &    latvap, latice, onebcp, kapa, cpbg, lvbcp, lsbsp
...
!! | gql            | graupel_mixing_ratio_updated_by_physics                                  | moist (dry+vapor, no condensates) mixing ratio of graupel updated by physics     | kg kg-1 |    2 | real      | kind_phys | inout  | F        |
!! | errmsg         | ccpp_error_message                                                       | error message for error handling in CCPP                                         | none    |    0 | character | len=*     | out    | F        |
!! | errflg         | ccpp_error_flag                                                          | error flag for error handling in CCPP                                            | flag    |    0 | integer   |           | out    | F        |
!!
