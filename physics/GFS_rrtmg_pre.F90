...
!!
      ...
      subroutine GFS_rrtmg_pre_run (im, levs, lm, lmk, lmp, n_var_lndp,        &
        ...
        imp_physics_fer_hires, imp_physics_nssl, julian, yearlen,              &
        lndp_var_list, lsswr, lslwr, ltaerosol, lgfdlmprad, uni_cld, effr_in,  &
        do_mynnedmf, lmfshal, lmfdeep2, fhswr, fhlwr, solhr, sup, eps, epsm1,  &
        fvirt,rog, rocp, con_rd, xlat_d, xlat, xlon, coslat, sinlat, tsfc,     &
        slmsk, prsi, prsl, prslk, tgrs, sfc_wts, mg_cld, effrr_in,             &
