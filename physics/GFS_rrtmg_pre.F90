...
!!
     ...
     &                                     proflw_type, NBDLW
      ...
      real(kind=kind_phys), dimension(:,:), intent(in) :: prsi, prsl, prslk,   &
                                                          ...
                                                          phy_f3d_cnvc
      ! F-A mp scheme only
      real(kind=kind_phys), dimension(im,lm+LTP), intent(in) :: f_ice, f_rain, &
                                                                f_rimef
      ...
      real(kind=kind_phys), dimension(im,lm+LTP+1) :: tem2db
!     real(kind=kind_phys), dimension(im,lm+LTP+1) :: hz
