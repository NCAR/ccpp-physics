...
!>
!! @brief Auto-generated cap module for the GFS_rad_time_vary scheme
!!
!
module GFS_rad_time_vary_cap
    ...
    use            :: GFS_rad_time_vary, &
                      only: GFS_rad_time_vary_init,GFS_rad_time_vary_run,GFS_rad_time_vary_finalize
    ...
    private
    public :: GFS_rad_time_vary_init_cap,GFS_rad_time_vary_run_cap,GFS_rad_time_vary_finalize_cap

    contains


    function GFS_rad_time_vary_init_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_rad_time_vary_init()
        

    end function GFS_rad_time_vary_init_cap

    function GFS_rad_time_vary_run_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_rad_time_vary_run(Model=Model,Data=Data,nthrds=nthrds,errmsg=cdata%errmsg,errflg=cdata%errflg)
        ierr=cdata%errflg

    end function GFS_rad_time_vary_run_cap

    function GFS_rad_time_vary_finalize_cap(ptr) bind(c) result(ierr)
        ...
        call GFS_rad_time_vary_finalize()
        

    end function GFS_rad_time_vary_finalize_cap
end module GFS_rad_time_vary_cap
