...
!!|   Statein         | FV3-GFS_Statein_type                                          | Fortran DDT containing FV3-GFS prognostic state data in from dycore           | DDT      |  0   | GFS_typedefs%GFS_stateout_type|           | in     | F        |
...
!!|   lmk             | adjusted_vertical_layer_dimension_for_radiation               | number of vertical layers for radiation                                       | index    |  0   | integer                       |           | out    | F        |
!!|   lmp             | adjusted_vertical_level_dimension_for_radiation               | number of vertical levels for radiation                                       | index    |  0   | integer                       |           | out    | F        |
...
!!|   olyr            | ozone_concentration_at_layer_for_radiation                    | ozone concentration                                                           | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_co2      | volume_mixing_ratio_co2                                       | CO2 volume mixing ratio                                                       | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_n2o      | volume_mixing_ratio_n2o                                       | N2O volume mixing ratio                                                       | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_ch4      | volume_mixing_ratio_ch4                                       | CH4 volume mixing ratio                                                       | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_o2       | volume_mixing_ratio_o2                                        | O2 volume mixing ratio                                                        | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_co       | volume_mixing_ratio_co                                        | CO volume mixing ratio                                                        | gm gm-1  |  2   | real                          | kind_phys | out    | F        | 
!!|   gasvmr_cfc11    | volume_mixing_ratio_cfc11                                     | CFC11 volume mixing ratio                                                     | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_cfc12    | volume_mixing_ratio_cfc12                                     | CFC12 volume mixing ratio                                                     | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_cfc22    | volume_mixing_ratio_cfc22                                     | CFC22 volume mixing ratio                                                     | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_ccl4     | volume_mixing_ratio_ccl4                                      | CCL4 volume mixing ratio                                                      | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
!!|   gasvmr_cfc113   | volume_mixing_ratio_cfc113                                    | CFC113 volume mixing ratio                                                    | gm gm-1  |  2   | real                          | kind_phys | out    | F        |
