...
!! | icseed          | seed_random_numbers_sw                                                  | seed for random number generation for shortwave radiation                | none    |    2 | integer     |           | in     | F        |
...
!! | cld_asy         | cloud_asymetry_parameter                                                | cloud asymetry parameter                                                 | none    |    2 | real        | kind_phys | in     | T        |
!!
