...
!! | qlyr            | water_vapor_specific_humidity_at_layer_for_radiation                    | specific humidity layer                                                  | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | olyr            | ozone_concentration_at_layer_for_radiation                              | ozone concentration layer                                                | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | gasvmr_co2      | volume_mixing_ratio_co2                                                 | volume mixing ratio co2                                                  | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | gasvmr_n2o      | volume_mixing_ratio_n2o                                                 | volume mixing ratio no2                                                  | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | gasvmr_ch4      | volume_mixing_ratio_ch4                                                 | volume mixing ratio ch4                                                  | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | gasvmr_o2       | volume_mixing_ratio_o2                                                  | volume mixing ratio o2                                                   | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | icseed          | seed_random_numbers                                                     | seed for random number generation                                        |         |    2 | integer     |           | in     | F        |
!! | aeraod          | aerosol_optical_depth_for_shortwave_bands_01-16                         | aerosol optical depth for shortwave bands 01-16                          |         |    3 | real        | kind_phys | in     | F        |
!! | aerssa          | aerosol_single_scattering_albedo_for_shortwave_bands_01-16              | aerosol single scattering albedo for shortwave bands 01-16               |         |    3 | real        | kind_phys | in     | F        |
!! | aerasy          | aerosol_asymmetry_parameter_for_shortwave_bands_01-16                   | aerosol asymmetry paramter for shortwave bands 01-16                     |         |    3 | real        | kind_phys | in     | F        |
!! | sfcalb_nir_dir  | surface_albedo_due_to_near_IR_direct                                    | surface albedo due to near IR direct beam                                |         |    1 | real        | kind_phys | in     | F        |
!! | sfcalb_nir_dif  | surface_albedo_due_to_near_IR_diffused                                  | surface albedo due to near IR diffused beam                              |         |    1 | real        | kind_phys | in     | F        |
!! | sfcalb_uvis_dir | surface_albedo_due_to_UV_and_VIS_direct                                 | surface albedo due to UV+VIS direct beam                                 |         |    1 | real        | kind_phys | in     | F        |
!! | sfcalb_uvis_dif | surface_albedo_due_to_UV_and_VIS_diffused                               | surface albedo due to UV+VIS diffused beam                               |         |    1 | real        | kind_phys | in     | F        |
...
!! | nlay            | adjusted_vertical_layer_dimension_for_radiation                         | number of vertical layers for radiation                                  | index   |    0 | integer     |           | in     | F        |
!! | nlp1            | adjusted_vertical_level_dimension_for_radiation                         | number of vertical levels for radiation                                  | index   |    0 | integer     |           | in     | F        |
!! | lprnt           | flag_to_print                                                           | logical flag to print                                                    | logical |    0 | logical     |           | in     | F        |
!! | cld_cf          | total_cloud_fraction                                                    | total cloud fraction                                                     |         |    2 | real        | kind_phys | in     | F        |
!! | lsswr           | flag_to_calc_sw                                                         | logical flag to calculate SW irradiances                                 | logical |    0 | logical     |           | in     | F        |
!! | hswc            | tendency_of_air_temperature_due_to_shortwave_heating                    | shortwave total sky heating rate                                         | k s-1   |    2 | real        | kind_phys | out    | F        |
...
!! | hsw0            | tendency_of_air_temperature_due_to_shortwave_heating_assuming_clear_sky | shortwave clear sky heating rate                                         | K s-1   |    2 | real        | kind_phys | out    | T        |
