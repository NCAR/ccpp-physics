...
!! | hswc            | tendency_of_air_temperature_due_to_shortwave_heating_on_radiation_timestep                    | shortwave total sky heating rate                                         | K s-1   |    2 | real        | kind_phys | out    | F        |
...
!! | hsw0            | tendency_of_air_temperature_due_to_shortwave_heating_assuming_clear_sky_on_radiation_timestep | shortwave clear sky heating rate                                         | K s-1   |    2 | real        | kind_phys | out    | T        |
