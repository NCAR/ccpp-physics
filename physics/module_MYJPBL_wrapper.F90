...
!! | do_myjsfc           | do_myjsfc                                                       | flag for MYJ surface layer scheme                     | flag          |    0 | logical          |           | in     | F        |
!! | ix                  | horizontal_dimension                                            | horizontal dimension                                  | count         |    0 | integer          |           | in     | F        |
!! | im                  | horizontal_loop_extent                                          | horizontal loop extent                                | count         |    0 | integer          |           | in     | F        |
!! | levs                | vertical_dimension                                              | vertical layer dimension                              | count         |    0 | integer          |           | in     | F        |
!! | dt_phs              | time_step_for_physics                                           | time step for physics                                 | s             |    0 | real             | kind_phys | in     | F        |
...
!! | qgrs                | vertically_diffused_tracer_concentration                        | tracer concentration diffused by PBL scheme           | kg kg-1       |    3 | real             | kind_phys | in     | F        |
...
!! | hprime1             | standard_deviation_of_subgrid_orography                         | standard deviation of subgrid orography               | m             |    1 | real             | kind_phys | in     | F        |
...
!! | tsfc                | surface_skin_temperature                                        | surface temperature                                   | K             |    1 | real             | kind_phys | inout  | F        |
...
!! | pblh                | atmosphere_boundary_layer_thickness                             | PBL thickness                                         | m             |    1 | real             | kind_phys | out    | F        |
...
!! | dqdt                | tendency_of_vertically_diffused_tracer_concentration            | updated tendency of the tracers PBL vertical diff     | kg kg-1 s-1   |    3 | real             | kind_phys | inout  | F        |
