...
!! | Grid           | FV3-GFS_Grid_type_tmp_all_blocks                                        | Fortran DDT containing FV3-GFS grid and interpolation related data      | DDT           |    1 | GFS_typedefs%GFS_grid_type    |           | in     | F        |
!! | Model          | FV3-GFS_Control_type                                                    | Fortran DDT containing FV3-GFS model control parameters                 | DDT           |    0 | GFS_typedefs%GFS_control_type |           | inout  | F        |
!! | Tbd            | FV3-GFS_Tbd_type_tmp_all_blocks                                         | Fortran DDT containing FV3-GFS miscellaneous data                       | DDT           |    1 | GFS_typedefs%GFS_tbd_type     |           | inout  | F        |
!! | Sfcprop        | FV3-GFS_Sfcprop_type_tmp_all_blocks                                     | Fortran DDT containing FV3-GFS surface fields                           | DDT           |    1 | GFS_typedefs%GFS_sfcprop_type |           | inout  | F        |
!! | Cldprop        | FV3-GFS_Cldprop_type_tmp_all_blocks                                     | Fortran DDT containing FV3-GFS cloud fields                             | DDT           |    1 | GFS_typedefs%GFS_cldprop_type |           | inout  | F        |
!! | Diag           | FV3-GFS_Diag_type_tmp_all_blocks                                        | Fortran DDT containing FV3-GFS fields targeted for diagnostic output    | DDT           |    1 | GFS_typedefs%GFS_diag_type    |           | inout  | F        |
!!
