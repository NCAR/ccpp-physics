...
!! | fm_ocn         | Monin_Obukhov_similarity_function_for_momentum_over_ocean                    | Monin-Obukhov similarity function for momentum over ocean        | none       |    1 | real      | kind_phys | inout  | F        |
!! | fm_lnd         | Monin_Obukhov_similarity_function_for_momentum_over_land                     | Monin-Obukhov similarity function for momentum over land         | none       |    1 | real      | kind_phys | inout  | F        |
!! | fm_ice         | Monin_Obukhov_similarity_function_for_momentum_over_ice                      | Monin-Obukhov similarity function for momentum over ice          | none       |    1 | real      | kind_phys | inout  | F        |
...
!! | fm10_ocn       | Monin_Obukhov_similarity_function_for_momentum_at_10m_over_ocean             | Monin-Obukhov similarity parameter for momentum at 10m over ocean | none      |    1 | real      | kind_phys | inout  | F        |
!! | fm10_lnd       | Monin_Obukhov_similarity_function_for_momentum_at_10m_over_land              | Monin-Obukhov similarity parameter for momentum at 10m over land | none       |    1 | real      | kind_phys | inout  | F        |
!! | fm10_ice       | Monin_Obukhov_similarity_function_for_momentum_at_10m_over_ice               | Monin-Obukhov similarity parameter for momentum at 10m over ice  | none       |    1 | real      | kind_phys | inout  | F        |
!! | fh2_ocn        | Monin_Obukhov_similarity_function_for_heat_at_2m_over_ocean                  | Monin-Obukhov similarity parameter for heat at 2m over ocean     | none       |    1 | real      | kind_phys | inout  | F        |
!! | fh2_lnd        | Monin_Obukhov_similarity_function_for_heat_at_2m_over_land                   | Monin-Obukhov similarity parameter for heat at 2m over land      | none       |    1 | real      | kind_phys | inout  | F        |
!! | fh2_ice        | Monin_Obukhov_similarity_function_for_heat_at_2m_over_ice                    | Monin-Obukhov similarity parameter for heat at 2m over ice       | none       |    1 | real      | kind_phys | inout  | F        |
