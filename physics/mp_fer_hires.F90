...
!!
     subroutine mp_fer_hires_init(ncol, nlev, dtp, imp_physics,         &
      ...
      real(kind_phys),                intent(out), optional  :: f_ice(:,:)
      real(kind_phys),                intent(out), optional  :: f_rain(:,:)
      real(kind_phys),                intent(out), optional  :: f_rimef(:,:)
...
!------------------------
      ...
      real(kind_phys),   intent(inout) :: f_ice(:,:)
      real(kind_phys),   intent(inout) :: f_rain(:,:) 
      real(kind_phys),   intent(inout) :: f_rimef(:,:)
