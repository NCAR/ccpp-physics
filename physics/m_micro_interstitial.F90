...
!!
      ...
      real(kind=kind_phys), intent(inout) :: gq0_ice(:,:)
      real(kind=kind_phys), intent(inout) :: gq0_rain(:,:)
      real(kind=kind_phys), intent(inout) :: gq0_snow(:,:)
      real(kind=kind_phys), intent(inout) :: gq0_graupel(:,:)
      real(kind=kind_phys), intent(inout) :: gq0_rain_nc(:,:)
      real(kind=kind_phys), intent(inout) :: gq0_snow_nc(:,:)
      real(kind=kind_phys), intent(inout) :: gq0_graupel_nc(:,:)
