...
!!
      ...
      real(kind=kind_phys), intent(out  ) :: gq0_rain_nc(1:im,1:levs)
      real(kind=kind_phys), intent(out  ) :: gq0_snow_nc(1:im,1:levs)
      real(kind=kind_phys), intent(out  ) :: gq0_graupel_nc(1:im,1:levs)
