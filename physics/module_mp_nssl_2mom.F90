...
!
      ...
      real :: gamc1,gamc2,gami1,gami2,gams1,gams2,gamr1,gamr2
      real :: factor_c, factor_i, factor_s, factor_r
      real :: lam_c, lam_i, lam_s, lam_r
      integer :: il
...
! Lambda for snow
         ...
         IF ( present( t4 ) .and. present(qrw) .and. present(crw) ) THEN
