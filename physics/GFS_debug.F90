         ...
         do impi=0,mpisize-1
             do iomp=0,ompsize-1
                 if (mpirank==impi .and. omprank==iomp) then
                     ...
                     ! Diag
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%fluxr       ',    Diag%fluxr)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%srunoff     ',    Diag%srunoff)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%evbsa       ',    Diag%evbsa)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%evcwa       ',    Diag%evcwa)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%snohfa      ',    Diag%snohfa)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%transa      ',    Diag%transa)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%sbsnoa      ',    Diag%sbsnoa)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%snowca      ',    Diag%snowca)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%soilm       ',    Diag%soilm)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%tmpmin      ',    Diag%tmpmin)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%tmpmax      ',    Diag%tmpmax)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dusfc       ',    Diag%dusfc)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dvsfc       ',    Diag%dvsfc)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dtsfc       ',    Diag%dtsfc)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dqsfc       ',    Diag%dqsfc)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%totprcp     ',    Diag%totprcp)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%totice      ',    Diag%totice)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%totsnw      ',    Diag%totsnw)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%totgrp      ',    Diag%totgrp)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%totprcpb    ',    Diag%totprcpb)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%toticeb     ',    Diag%toticeb)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%totsnwb     ',    Diag%totsnwb)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%totgrpb     ',    Diag%totgrpb)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%suntim      ',    Diag%suntim)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%runoff      ',    Diag%runoff)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%ep          ',    Diag%ep)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%cldwrk      ',    Diag%cldwrk)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dugwd       ',    Diag%dugwd)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dvgwd       ',    Diag%dvgwd)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%psmean      ',    Diag%psmean)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%cnvprcp     ',    Diag%cnvprcp)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%cnvprcpb    ',    Diag%cnvprcpb)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%spfhmin     ',    Diag%spfhmin)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%spfhmax     ',    Diag%spfhmax)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%u10mmax     ',    Diag%u10mmax)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%v10mmax     ',    Diag%v10mmax)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%wind10mmax  ',    Diag%wind10mmax)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%rain        ',    Diag%rain)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%rainc       ',    Diag%rainc)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%ice         ',    Diag%ice)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%snow        ',    Diag%snow)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%graupel     ',    Diag%graupel)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%u10m        ',    Diag%u10m)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%v10m        ',    Diag%v10m)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dpt2m       ',    Diag%dpt2m)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%zlvl        ',    Diag%zlvl)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%psurf       ',    Diag%psurf)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%hpbl        ',    Diag%hpbl)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%pwat        ',    Diag%pwat)
                     ...
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%chh         ',    Diag%chh)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%cmm         ',    Diag%cmm)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%epi         ',    Diag%epi)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%smcwlt2     ',    Diag%smcwlt2)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%smcref2     ',    Diag%smcref2)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%tdomr       ',    Diag%tdomr)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%tdomzr      ',    Diag%tdomzr)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%tdomip      ',    Diag%tdomip)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%tdoms       ',    Diag%tdoms)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%snowfallac  ',    Diag%snowfallac)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%acsnow      ',    Diag%acsnow)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%skebu_wts   ',    Diag%skebu_wts)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%skebv_wts   ',    Diag%skebv_wts)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%sppt_wts    ',    Diag%sppt_wts)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%shum_wts    ',    Diag%shum_wts)
                     call print_var(mpirank,omprank, Tbd%blkno, 'Diag%zmtnblck    ',    Diag%zmtnblck)
                     if (Model%ldiag3d) then
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%du3dt       ',    Diag%du3dt)
                       do n=1,size(Diag%du3dt(1,1,:))
                         call print_var(mpirank,omprank, Tbd%blkno, 'Diag%du3dt_n     ',  Diag%du3dt(:,:,n))
                       end do
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dv3dt       ',    Diag%dv3dt)
                       do n=1,size(Diag%dv3dt(1,1,:))
                         call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dv3dt_n     ',  Diag%dv3dt(:,:,n))
                       end do
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dt3dt       ',    Diag%dt3dt)
                       do n=1,size(Diag%dt3dt(1,1,:))
                         call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dt3dt_n     ',  Diag%dt3dt(:,:,n))
                       end do
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dq3dt       ',    Diag%dq3dt)
                       do n=1,size(Diag%dq3dt(1,1,:))
                         call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dq3dt_n     ',  Diag%dq3dt(:,:,n))
                       end do
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%upd_mf      ',    Diag%upd_mf)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%dwn_mf      ',    Diag%dwn_mf)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%det_mf      ',    Diag%det_mf)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%cldcov      ',    Diag%cldcov)
                     end if
                     if(Model%lradar) then
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%refl_10cm   ',  Diag%refl_10cm)
                     end if
                     if (Model%do_mynnedmf) then
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%edmf_a      ',  Diag%edmf_a)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%edmf_w      ',  Diag%edmf_w)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%edmf_qt     ',  Diag%edmf_qt)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%edmf_thl    ',  Diag%edmf_thl)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%edmf_ent    ',  Diag%edmf_ent)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%edmf_qc     ',  Diag%edmf_qc)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%nupdraft    ',  Diag%nupdraft)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%maxMF       ',  Diag%maxMF)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%ktop_shallow',  Diag%ktop_shallow)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%exch_h      ',  Diag%exch_h)
                       call print_var(mpirank,omprank, Tbd%blkno, 'Diag%exch_m      ',  Diag%exch_m)
                     end if
                     ! Statein
