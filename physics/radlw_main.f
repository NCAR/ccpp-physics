...
!! | gasvmr_co       | volume_mixing_ratio_co                                                                       | volume mixing ratio co                                     | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | gasvmr_cfc11    | volume_mixing_ratio_cfc11                                                                    | volume mixing ratio cfc11                                  | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | gasvmr_cfc12    | volume_mixing_ratio_cfc12                                                                    | volume mixing ratio cfc12                                  | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | gasvmr_cfc22    | volume_mixing_ratio_cfc22                                                                    | volume mixing ratio cfc22                                  | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | gasvmr_ccl4     | volume_mixing_ratio_ccl4                                                                     | volume mixing ratio ccl4                                   | gm gm-1 |    2 | real        | kind_phys | in     | F        |
!! | icseed          | seed_random_numbers                                                                          | seed for random number generation                          |         |    2 | integer     |           | in     | F        |
!! | aeraod          | aerosol_optical_depth_for_longwave_bands_01-16                                               | aerosol optical depth for longwave bands 01-16             |         |    3 | real        | kind_phys | in     | F        |
!! | aerssa          | aerosol_single_scattering_albedo_for_longwave_bands_01-16                                    | aerosol single scattering albedo for longwave bands 01-16  |         |    3 | real        | kind_phys | in     | F        |
