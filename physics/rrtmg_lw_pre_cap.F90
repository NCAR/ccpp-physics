...
!>
!! @brief Auto-generated cap module for the rrtmg_lw_pre scheme
!!
!
module rrtmg_lw_pre_cap
    ...
    use            :: rrtmg_lw_pre, &
                      only: rrtmg_lw_pre_run,rrtmg_lw_pre_init,rrtmg_lw_pre_finalize
    ...
    private
    public :: rrtmg_lw_pre_run_cap,rrtmg_lw_pre_init_cap,rrtmg_lw_pre_finalize_cap
    ...
    function rrtmg_lw_pre_run_cap(ptr) bind(c) result(ierr)
        ...
        call rrtmg_lw_pre_run(Model=Model,Grid=Grid,Sfcprop=Sfcprop,Radtend=Radtend,im=im,tsfg=tsfg,tsfa=tsfa, &
