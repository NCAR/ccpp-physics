...
!  ---  in
      ...
      real (kind=kind_phys), dimension(im), intent(in) :: sncovr_ice
...
!  ---  inout
      ...
      real (kind=kind_phys), dimension(im),           intent(inout) :: semis_lnd
...
!  ---  out
      ...
      real (kind=kind_phys), dimension(im),           intent(out) :: sfalb_lnd_bck
