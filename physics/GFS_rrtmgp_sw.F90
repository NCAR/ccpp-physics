...
!! | kdist_sw        | K_distribution_file_for_RRTMGP_SW_scheme        | DDT containing spectral information for RRTMGP SW radiation scheme | DDT   |    0 | ty_gas_optics_rrtmgp_type |           | inout  | F        |
!! | kdist_sw_cldy   | K_distribution_file_for_cloudy_RRTMGP_SW_scheme | DDT containing spectral information for cloudy RRTMGP SW radiation scheme | DDT   |    0 | ty_cloud_optics_type |           | inout  | F        |
!!
  ! #########################################################################################
