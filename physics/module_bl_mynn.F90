...
!   **  3.8 = 0.622*6.11 (hPa)  **
      ...
      CASE (2, -2)
        ...
        DO k = kts,kte-1
           ...
           !SPP
           qw_pert = qw(k) + qw(k)*0.66*rstoch_col(k)*real(spp_pbl)
