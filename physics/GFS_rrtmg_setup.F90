...
!! | ictm                     | flag_for_initial_time_date_control                                            | flag for initial conditions and forcing                       | flag          |    0 | integer   |           | in     | F        |
...
!! | iovr_sw                  | flag_for_max_random_overlap_clouds_for_shortwave_radiation                    | sw: max-random overlap clouds                                 | flag          |    0 | integer   |           | in     | F        |
!! | iovr_lw                  | flag_for_max_random_overlap_clouds_for_longwave_radiation                     | lw: max-random overlap clouds                                 | flag          |    0 | integer   |           | in     | F        |
!! | isubc_sw                 | flag_for_sw_clouds_without_sub_grid_approximation                             | flag for sw clouds without sub-grid approximation             | flag          |    0 | integer   |           | in     | F        |
!! | isubc_lw                 | flag_for_lw_clouds_without_sub_grid_approximation                             | flag for lw clouds without sub-grid approximation             | flag          |    0 | integer   |           | in     | F        |
...
!! | crick_proof              | flag_for_CRICK_proof_cloud_water                                              | flag for CRICK-Proof cloud water                              | flag          |    0 | logical   |           | in     | F        |
...
!! | faerlw                   | aerosol_optical_properties_for_longwave_bands_01_16                           | optical properties for longwave bands 01-16                   | various       |    4 | real      | kind_phys | in     | F        |
!! | faersw                   | aerosol_optical_properties_for_shortwave_bands_01_16                          | aerosol optical properties for shortwave bands 01-16          | various       |    4 | real      | kind_phys | in     | F        |
