...
!! \section arg_table_gfdl_cloud_microphys_pre_init  Argument Table
...
subroutine gfdl_cloud_microphys_pre_run(                                      &         
      levs, frland, Garea,                                                    &  !! input
      gq0, gq0_ntcw, gq0_ntrw, gq0_ntiw, gq0_ntsw, gq0_ntgl, gq0_ntclamt,     &
      gt0, vvl, prsl, gu0, gv0, phii, del, con_g, con_rd, fhour,              &
...
!! | frland    | land_fraction                                              | land fraction                                         | fraction    | 1   | real      | kind_phys | in    | F |
!! | Garea     | cell_area                                                  | area of grid cell                                     | m2          | 1   | real      | kind_phys | in    | F |
!! | gq0       | water_vapor_specific_humidity_updated_by_physics           | water vapor specific humidity updated by physics      | kg kg-1     | 2   | real      | kind_phys | in    | F |
!! | gq0_ntcw  | cloud_condensed_water_specific_humidity_updated_by_physics | cloud condensed water  spec humid updated by physics  | kg kg-1     | 2   | real      | kind_phys | in    | F |
!! | gq0_ntrw  | moist_mixing_ratio_of_rain_water_updated_by_physics        | moist mixing ratio of rain updated by physics         | kg kg-1     | 2   | real      | kind_phys | in    | F |
!! | gq0_ntiw  | moist_mixing_ratio_of_cloud_ice_water_updated_by_physics   | moist mixing ratio of cloud ice updated by physics    | kg kg-1     | 2   | real      | kind_phys | in    | F |
!! | gq0_ntsw  | moist_mixing_ratio_of_snow_water_updated_by_physics        | moist mixing ratio of snow updated by physics         | kg kg-1     | 2   | real      | kind_phys | in    | F |
!! | gq0_ntgl  | moist_mixing_ratio_of_graupel_updated_by_physics           | moist mixing ratio of graupel updated by physics      | kg kg-1     | 2   | real      | kind_phys | in    | F |
!! | gq0_ntclamt | cloud_area_fraction                                      | cloud area fraction                                   | fraction    | 2   | real      | kind_phys | in    | F |
!! | gt0       | air_temperature_updated_by_physics                         | air temperature updated by physics                    | K           | 2   | real      | kind_phys | in    | F |
...
!! | gu0       | zonal_wind_updated_by_physics                              | zonal wind updated by physics                         | m s-1       | 2   | real      | kind_phys | in    | F |
!! | gv0       | meridional_wind_updated_by_physics                         | meridional wind updated by physics                    | m s-1       | 2   | real      | kind_phys | in    | F |
!! | phii      | geopotential_at_interface                                  | geopotential at model layer interfaces                | m2 s-2      | 2   | real      | kind_phys | in    | F |
!! | del       | air_pressure_difference_between_midlayer                   | air pressure difference between mid-layer             | Pa          | 2   | real      | kind_phys | in    | F |
!! | con_g     | gravity                                                    | acceleration due to gravity in mks                    | m s-2       | 0   | real      | kind_phys | in    | F |
!! | con_rd    | gas_constant_dry_air                                       | ideal gas constant for dry air                        | J kg-1 K-1  | 0   | real      | kind_phys | in    | F |
!! | fhour     | forecast_time                                              | curent forecast time in hours                         | h           | 0   | real      | kind_phys | in    | F |
!! | land      | land_fraction                                              | land fraction                                         | fraction    | 2   | real      | kind_phys |   out | F |
!! | area      | cell_area                                                  | area of grid cell                                     | m2          | 2   | real      | kind_phys |   out | F | 
!! | rain0     | column_integrated_rate_of_change_of_rain                   | column integrated rate of change of rain              | mm day-1    | 2   | real      | kind_phys |   out | F |
!! | snow0     | column_integrated_rate_of_change_of_snow                   | column integrated rate of change of snow              | mm day-1    | 2   | real      | kind_phys |   out | F |
!! | ice0      | column_integrated_rate_of_change_of_ice                    | column integrated rate of change of ice               | mm day-1    | 2   | real      | kind_phys |   out | F |
!! | graupel0  | column_integrated_rate_of_change_of_graupel                | column integrated rate of change of graupel           | mm day-1    | 2   | real      | kind_phys |   out | F |
!! | qn1       | cloud_condensation_nuclei                                  | cloud condensation nuclei (not used)                  | unitless    | 3   | real      | kind_phys |   out | F |
!! | qv_dt     | tendency_of_water_vapor_specific_humidity                  | tendency of water vapor specific humidity             | kg kg-1 s-1 | 3   | real      | kind_phys |   out | F | 
!! | ql_dt     | tendency_of_cloud_condensed_water_specific_humidity        | tendency of cloud condensed water specific humidity   | kg kg-1 s-1 | 3   | real      | kind_phys |   out | F |
!! | qr_dt     | tendency_of_moist_mixing_ratio_of_rain_water               | tendency of moist mixing ratio of rain water          | kg kg-1 s-1 | 3   | real      | kind_phys |   out | F |
!! | qi_dt     | tendency_of_moist_mixing_ratio_of_cloud_ice_water          | tendency of moist mixing ratio of cloud ice water     | kg kg-1 s-1 | 3   | real      | kind_phys |   out | F |
!! | qs_dt     | tendency_of_moist_mixing_ratio_of_snow_water               | tendency of moist mixing ratio of snow water          | kg kg-1 s-1 | 3   | real      | kind_phys |   out | F |
!! | qg_dt     | tendency_of_moist_mixing_ratio_of_graupel                  | tendency of moist mixing ratio of graupel             | kg kg-1 s-1 | 3   | real      | kind_phys |   out | F |
!! | qa_dt     | tendency_of_cloud_area_fraction                            | tendency of cloud area fraction                       | kg kg-1 s-1 | 3   | real      | kind_phys |   out | F |
!! | pt_dt     | air_temperature_updated_by_physics                         | air temperature updated by physics                    | K           | 3   | real      | kind_phys |   out | F |
!! | udt       | rate_of_change_zonal_momentum                              | rate of change zonal momentum                         | m s-2       | 3   | real      | kind_phys |   out | F | 
!! | vdt       | rate_of_change_meridional_momentum                         | rate of change meridional momentum                    | m s-2       | 3   | real      | kind_phys |   out | F |
!! | qv1       | k_flipped_water_vapor_specific_humidity_updated_by_physics | k flipped water vapor specific humidity updated by phys | kg kg-1   | 3   | real      | kind_phys |   out | F |
!! | ql1  | k_flipped_cloud_condensed_water_specific_humidity_updated_by_physics | k flipped cloud condensed water spec humid updated by phys | kg kg-1 | 3 | real  | kind_phys |   out | F |
!! | qr1       | k_flipped_moist_mixing_ratio_of_rain_water_updated_by_physics | k flipped moist mixing ratio of rain updated by phys | kg kg-1   | 3   | real      | kind_phys |   out | F |
!! | qi1  | k_flipped_moist_mixing_ratio_of_cloud_ice_water_updated_by_physics | k flipped moist mixing ratio of cloud ice updated by phys | kg kg-1 | 3 | real     | kind_phys |   out | F |
!! | qs1       | k_flipped_moist_mixing_ratio_of_snow_water_updated_by_physics | k flipped moist mixing ratio of snow updated by phys | kg kg-1   | 3   | real      | kind_phys |   out | F |
!! | qg1       | k_flipped_moist_mixing_ratio_of_graupel_updated_by_physics | k flipped moist mixing ratio of graupel updated by phys | kg kg-1   | 3   | real      | kind_phys |   out | F |
!! | qa1       | k_flipped_cloud_area_fraction                              | k flipped cloud area fraction                         | fraction    | 3   | real      | kind_phys |   out | F |
!! | pt        | k_flipped_air_temperature_updated_by_physics               | k flipped air temperature updated by physics          | K           | 3   | real      | kind_phys |   out | F |
!! | w         | k_flipped_vertical_velocity                                | k flipped vertical velocity                           | m2 s-2      | 3   | real      | kind_phys |   out | F |
!! | uin       | k_flipped_zonal_wind_updated_by_physics                    | k flipped zonal wind updated by physics               | m s-1       | 3   | real      | kind_phys |   out | F |
...
!  ---  interface variables (input)
          integer,              intent(in   )                    :: levls
          real(kind=kind_phys), intent(in   )                    :: con_g, con_rd, fhour
...
!! flip vertical (k) coordinate, and add third index.  
          do k = 1, levls
            qv1  (:,1,k) = gq0(:,levs-k+1)
            ql1  (:,1,k) = gq0_ntcw(:,levs-k+1)
            qr1  (:,1,k) = gq0_ntrw(:,levs-k+1)
            qi1  (:,1,k) = gq0_ntiw(:,levs-k+1)
            qs1  (:,1,k) = gq0_ntsw(:,levs-k+1)
            qg1  (:,1,k) = gq0_ntgl(:,levs-k+1)
            qa1  (:,1,k) = gq0_ntclamt(:,levs-k+1)
            pt   (:,1,k) = gt0(:,levs-k+1)
            w    (:,1,k) = -vvl(:,levs-k+1)*con_rd*gt0(:,levs-k+1)     &
     &                   /prsl(:,levs-k+1)/con_g
            uin  (:,1,k) = gu0(:,levs-k+1)
            vin  (:,1,k) = gv0(:,levs-k+1)
            delp (:,1,k) = del(:,levs-k+1)
            dz   (:,1,k) = (phii(:,levs-k+1)-phii(:,levs-k+2))/con_g
          enddo
...
subroutine gfdl_cloud_microphys_post_run(                                            &
               levs, im, dtp,                                                        &    !! input
               rain0, ice0, snow0, graupel0,                                         &
               qv1, ql1, qr1, qi1, qs1, qg1, qa1,                                    &
               qv_dt, ql_dt, qr_dt, qi_dt, qs_dt, qg_dt, qa_dt, pt_dt, udt, vdt,     &
               ice, snow, graupel, sr,                                               &    !! output
               gq0, gq0_ntcw, gq0_ntrw, gq0_ntiw, gq0_ntsw, gq0_ntgl, gq0_ntclamt,   &
               gt0, gu0, gv0)
...
!! | qi1   | k_flipped_moist_mixing_ratio_of_cloud_ice_water_updated_by_physics | moist mixing ratio of cloud ice updated by physics  | kg kg-1      | 3    | real      | kind_phys | in     | F      |
!! | qs1   | k_flipped_moist_mixing_ratio_of_snow_water_updated_by_physics   | moist mixing ratio of snow updated by physics          | kg kg-1      | 3    | real      | kind_phys | in     | F      |
!! | qg1   | k_flipped_moist_mixing_ratio_of_graupel_updated_by_physics      | moist mixing ratio of graupel updated by physics       | kg kg-1      | 3    | real      | kind_phys | in     | F      |
!! | qa1   | k_flipped_cloud_area_fraction                                   | cloud area fraction                                    | fraction     | 3    | real      | kind_phys | in     | F      |
!! | qv_dt      | tendency_of_water_vapor_specific_humidity                  | tendency of water vapor specific humidity              | kg kg-1 s-1  | 3    | real      | kind_phys | in     | F      |
!! | ql_dt      | tendency_of_cloud_condensed_water_specific_humidity        | tendency of cloud condensed water specific humidity    | kg kg-1 s-1  | 3    | real      | kind_phys | in     | F      |
!! | qr_dt      | tendency_of_moist_mixing_ratio_of_rain_water               | tendency of moist mixing ratio of rain water           | kg kg-1 s-1  | 3    | real      | kind_phys | in     | F      |
!! | qi_dt      | tendency_of_moist_mixing_ratio_of_cloud_ice_water          | tendency of moist mixing ratio of cloud ice water      | kg kg-1 s-1  | 3    | real      | kind_phys | in     | F      |
!! | qs_dt      | tendency_of_moist_mixing_ratio_of_snow_water               | tendency of moist mixing ratio of snow water           | kg kg-1 s-1  | 3    | real      | kind_phys | in     | F      |
!! | qg_dt      | tendency_of_moist_mixing_ratio_of_graupel                  | tendency of moist mixing ratio of graupel              | kg kg-1 s-1  | 3    | real      | kind_phys | in     | F      |
!! | qa_dt      | tendency_of_cloud_area_fraction                            | tendency of cloud area fraction                        | kg kg-1 s-1  | 3    | real      | kind_phys | in     | F      |
!! | pt_dt      | air_temperature_updated_by_physics                         | air temperature updated by physics                     | K            | 3    | real      | kind_phys | in     | F      |
!! | udt        | rate_of_change_zonal_momentum                              | rate of change zonal momentum                          | m s-2        | 3    | real      | kind_phys | in     | F      |
!! | vdt        | rate_of_change_meridional_momentum                         | rate of change meridional momentum                     | m s-2        | 3    | real      | kind_phys | in     | F      |
!! | ice        | column_integrated_water_from_ice                           | ice water diagnostic output                            | m            | 1    | real      | kind_phys |   out  | F      |
!! | snow       | column_integrated_water_from_snow                          | snow water diagnostic output                           | m            | 1    | real      | kind_phys |   out  | F      |
!! | graupel    | column_integrated_water_from_graupel                       | graupel water diagnostic output                        | m            | 1    | real      | kind_phys |   out  | F      |
!! | sr         | ratio_of_snowfall_to_rainfall                              | ratio of snow to total precipitation                   | fraction     | 1    | real      | kind_phys |   out  | F      |
!! | gq0        | water_vapor_specific_humidity_updated_by_physics           | water vapor specific humidity updated by physics       | kg kg-1      | 2    | real      | kind_phys |   out  | F      |
!! | gq0_ntcw   | cloud_condensed_water_specific_humidity_updated_by_physics | cloud condensed water  spec humid updated by physics   | kg kg-1      | 2    | real      | kind_phys |   out  | F      |
!! | gq0_ntrw   | moist_mixing_ratio_of_rain_water_updated_by_physics        | moist mixing ratio of rain updated by physics          | kg kg-1      | 2    | real      | kind_phys |   out  | F      |
!! | gq0_ntiw   | moist_mixing_ratio_of_cloud_ice_water_updated_by_physics   | moist mixing ratio of cloud ice updated by physics     | kg kg-1      | 2    | real      | kind_phys |   out  | F      |
!! | gq0_ntsw   | moist_mixing_ratio_of_snow_water_updated_by_physics        | moist mixing ratio of snow updated by physics          | kg kg-1      | 2    | real      | kind_phys |   out  | F      |
!! | gq0_ntgl   | moist_mixing_ratio_of_graupel_updated_by_physics           | moist mixing ratio of graupel updated by physics       | kg kg-1      | 2    | real      | kind_phys |   out  | F      |
!! | gq0_ntclamt | cloud_area_fraction                                       | cloud area fraction                                    | fraction     | 2    | real      | kind_phys |   out  | F      |
!! | gt0        | air_temperature_updated_by_physics                         | air temperature updated by physics                     | K            | 2    | real      | kind_phys |   out  | F      |
!! | gu0        | zonal_wind_updated_by_physics                              | zonal wind updated by physics                          | m s-1        | 2    | real      | kind_phys |   out  | F      |
!! | gv0        | meridional_wind_updated_by_physics                         | meridional wind updated by physics                     | m s-1        | 2    | real      | kind_phys |   out  | F      |
!! |------------|------------------------------------------------------------|--------------------------------------------------------|--------------|------|-----------|-----------|--------|--------|
!!
      implicit none
!
...
!
!  ---  interface variables (output)
          real(kind=kind_phys), intent(  out), dimension(:)      :: ice, snow, graupel, sr
          real(kind=kind_phys), intent(  out), dimension(:,:)    :: gq0, gq0_ntcw, gq0_ntrw, gq0_ntiw, gq0_ntsw, gq0_ntgl, gq0_ntclamt
...
!  ---  local variables
          ...
          ice(:)     = ice0    (:,1) * dtp * con_p001 / con_day
          snow(:)    = snow0   (:,1) * dtp * con_p001 / con_day
          graupel(:) = graupel0(:,1) * dtp * con_p001 / con_day
          do i = 1, im
          ...
          enddo
          do k = 1, levls
            gq0(:,k) = qv1(:,1,levs-k+1) + qv_dt(:,1,levs-k+1) * dtp
            gq0_ntcw(:,k) = ql1(:,1,levs-k+1) + ql_dt(:,1,levs-k+1) * dtp
            gq0_ntrw(:,k) = qr1(:,1,levs-k+1) + qr_dt(:,1,levs-k+1) * dtp
            gq0_ntiw(:,k) = qi1(:,1,levs-k+1) + qi_dt(:,1,levs-k+1) * dtp
            gq0_ntsw(:,k) = qs1(:,1,levs-k+1) + qs_dt(:,1,levs-k+1) * dtp
            gq0_ntgl(:,k) = qg1(:,1,levs-k+1) + qg_dt(:,1,levs-k+1) * dtp
            gq0_ntclamt(:,k) = qa1(:,1,levs-k+1) + qa_dt(:,1,levs-k+1) * dtp
            gt0(:,k)   = gt0(:,k) + pt_dt(:,1,levs-k+1) * dtp
            gu0(:,k)   = gu0(:,k) + udt  (:,1,levs-k+1) * dtp
            gv0(:,k)   = gv0(:,k) + vdt  (:,1,levs-k+1) * dtp
          enddo
...
module gfdl_cloud_microphys_mod
    ...
    public gfdl_cloud_microphys_run, gfdl_cloud_microphys_init, gfdl_cloud_microphys_end
    ...
    ! integer :: gfdl_mp_clock ! clock for timing of run routine
...
!! | local_name | standard_name                                        | long_name                                               | units        | rank | type      | kind      | intent | optional |
!! |------------|------------------------------------------------------|---------------------------------------------------------|--------------|------|-----------|-----------|--------|---|
!! | qv         | k_flipped_water_vapor_specific_humidity_updated_by_physics | k flipped water vapor spec humid updated by phys  | kg kg-1      | 3    | real      | kind_phys | in     | F |
!! | ql   | k_flipped_cloud_condensed_water_specific_humidity_updated_by_physics | k flipped cloud condensed water  spec humid updated by phys | kg kg-1 | 3 | real| kind_phys | in     | F |
!! | qr   | k_flipped_moist_mixing_ratio_of_rain_water_updated_by_physics | k_flipped moist mixing ratio of rain updated by phys | kg kg-1      | 3    | real      | kind_phys | in     | F |
!! | qi   | k_flipped_moist_mixing_ratio_of_cloud_ice_water_updated_by_physics | k flipped moist mixing ratio of cloud ice updated by phys | kg kg-1 | 3 | real    | kind_phys | inout  | F |
!! | qs   | k_flipped_moist_mixing_ratio_of_snow_water_updated_by_physics | k flipped moist mixing ratio of snow updated by phys | kg kg-1      | 3    | real      | kind_phys | inout  | F |
!! | qg   | k_flipped_moist_mixing_ratio_of_graupel_updated_by_physics | k flipped moist mixing ratio of graupel updated by phys | kg kg-1      | 3    | real      | kind_phys | in     | F |
!! | qa         | k_flipped_cloud_area_fraction                        | cloud area fraction                                     | fraction     | 3    | real      | kind_phys | in     | F |
!! | qn         | cloud_condensation_nuclei                            | cloud condensation nuclei (not used)                    | unitless     | 3    | real      | kind_phys | in     | F |
!! | qv_dt      | tendency_of_water_vapor_specific_humidity            | tendency of water vapor specific humidity               | kg kg-1 s-1  | 3    | real      | kind_phys | inout  | F |
!! | ql_dt      | tendency_of_cloud_condensed_water_specific_humidity  | tendency of cloud condensed water specific humidity     | kg kg-1 s-1  | 3    | real      | kind_phys | inout  | F |
!! | qr_dt      | tendency_of_moist_mixing_ratio_of_rain_water         | tendency of moist mixing ratio of rain water            | kg kg-1 s-1  | 3    | real      | kind_phys | inout  | F |
!! | qi_dt      | tendency_of_moist_mixing_ratio_of_cloud_ice_water    | tendency of moist mixing ratio of cloud ice water       | kg kg-1 s-1  | 3    | real      | kind_phys | inout  | F |
!! | qs_dt      | tendency_of_moist_mixing_ratio_of_snow_water         | tendency of moist mixing ratio of snow water            | kg kg-1 s-1  | 3    | real      | kind_phys | inout  | F |
!! | qg_dt      | tendency_of_moist_mixing_ratio_of_graupel            | tendency of moist mixing ratio of graupel               | kg kg-1 s-1  | 3    | real      | kind_phys | inout  | F |
!! | qa_dt      | tendency_of_cloud_area_fraction                      | tendency of cloud area fraction                         | kg kg-1 s-1  | 3    | real      | kind_phys | inout  | F |
!! | pt_dt      | tendency_of_air_temperature                          | tendency of air temperature                             | K s-1        | 3    | real      | kind_phys | inout  | F |
!! | pt         | k_flipped_air_temperature_updated_by_physics         | k flipped air temperature updated by physics            | K            | 3    | real      | kind_phys | in     | F |
!! | w          | k_flipped_vertical_velocity                          | k flipped vertical velocity                             | m2 s-2       | 3    | real      | kind_phys | inout  | F |
!! | uin        | k_flipped_zonal_wind_updated_by_physics              | k flipped zonal wind updated by physics                 | m s-1        | 3    | real      | kind_phys | in     | F |
!! | vin        | k_flipped_meridional_wind_updated_by_physics         | k flipped meridional wind updated by physics            | m s-1        | 3    | real      | kind_phys | in     | F |
!! | udt        | rate_of_change_zonal_momentum                        | rate of change zonal momentum                           | m s-2        | 3    | real      | kind_phys | inout  | F |
!! | vdt        | rate_of_change_meridional_momentum                   | rate of change meridional momentum                      | m s-2        | 3    | real      | kind_phys | inout  | F |
!! | dz         | k_flipped_physical_layer_thickness                   | k flipped physical layer thickness                      | m            | 3    | real      | kind_phys | in     | F |
!! | delp       | k_flipped_air_pressure_difference_between_midlayer   | k flipped air pressure difference between mid-layer     | Pa           | 3    | real      | kind_phys | in     | F |
!! | area       | cell_area                                            | area of grid cell                                       | m2           | 2    | real      | kind_phys | in     | F |
!! | dt_in      | time_step_for_physics                                | time step for physics                                   | s            | 0    | real      | kind_phys | in     | F |
!! | land       | land_fraction                                        | land fraction                                           | fraction     | 2    | real      | kind_phys | in     | F |
!! | rain       | column_integrated_rate_of_change_of_rain             | column integrated rate of change of rain                | mm day-1     | 2    | real      | kind_phys |   out  | F |
!! | snow       | column_integrated_rate_of_change_of_snow             | column integrated rate of change of snow                | mm day-1     | 2    | real      | kind_phys |   out  | F |
!! | ice        | column_integrated_rate_of_change_of_ice              | column integrated rate of change of ice                 | mm day-1     | 2    | real      | kind_phys |   out  | F |
!! | graupel    | column_integrated_rate_of_change_of_graupel          | column integrated rate of change of graupel             | mm day-1     | 2    | real      | kind_phys |   out  | F |
!! | hydrostatic | flag_hydrostatic                                    | flag indicating hydrostatic model                       | flag         | 0    | logical   |           | in     | F |
!! | phys_hydrostatic | flag_phys_hydrostatic                          | flag indicating that physics are hydrostatic            | flag         | 0    | logical   |           | in     | F |
!! | iis        | x_horizontal_index_at_domain_start                   | x start of physics window                               | count        | 0    | integer   |           | in     | F |
!! | iie        | x_horizontal_index_at_domain_end                     | x end of physics window                                 | count        | 0    | integer   |           | in     | F |
!! | jjs        | y_horizontal_index_at_domain_start                   | y start of physics window                               | count        | 0    | integer   |           | in     | F |
!! | jje        | y_horizontal_index_at_domain_end                     | y end of physics window                                 | count        | 0    | integer   |           | in     | F |
!! | kks        | vertical_index_at_cloud_base                         | vertical index for base                                 | count        | 0    | integer   |           | in     | F |
