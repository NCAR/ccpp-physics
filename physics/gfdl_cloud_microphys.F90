...
subroutine gfdl_cloud_microphys_work (iis, iie, jjs, jje, kks, kke, ktop, kbot, &
...
end subroutine gfdl_cloud_microphys_work
...
! =======================================================================
!>@brief The subroutine 'qsmith_setup' initializes lookup tables for saturation
