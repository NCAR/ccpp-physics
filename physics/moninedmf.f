...
!! | phii           | geopotential_height_at_model_layer_interfaces          | geopotential height at model layer interfaces      | m             |    2 | real    | kind_phys | in     | F        |
!! | phil           | geopotential_height_layer                              | geopotential height at model layer                 | m             |    2 | real    | kind_phys | in     | F        |
!! | delt           | timestep_for_physics                                   | time step for physics                              | s             |    0 | real    | kind_phys | in     | F        |
...
!! | hpbl           | atmosphere_boundary_layer_height                       | PBL height                                         | m             |    1 | real    | kind_phys | out    | F        |
