...
!!
      subroutine GFS_SCNV_generic_pre_run (Model, Stateout, Grid, save_t, save_qv)
...
!!
      subroutine GFS_SCNV_generic_post_run (Model, Stateout, Grid, save_t, save_qv, frain, Diag, clw)
