...
!! | dtsfci_cpl                   | cumulative_surface_upward_sensible_heat_flux_for_coupling                         | instantaneous sfc sensible heat flux                                                        | W m-2         |    1 | real      | kind_phys | inout  | F        |
!! | dqsfci_cpl                   | cumulative_surface_upward_latent_heat_flux_for_coupling                           | instantaneous sfc latent heat flux                                                          | W m-2         |    1 | real      | kind_phys | inout  | F        |
