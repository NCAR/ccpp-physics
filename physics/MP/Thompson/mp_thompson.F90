...
!>@{
      subroutine mp_thompson_run(ncol, nlev, con_g, con_rd,        &
         ...
         !  !txri       => null()
         !  !txrc       => null()
         if (.not. ext_diag) then
            deallocate(prw_vcdc   )
            deallocate(prw_vcde   )
            deallocate(tpri_inu   )
            deallocate(tpri_ide_d )
            deallocate(tpri_ide_s )
            deallocate(tprs_ide   )
            deallocate(tprs_sde_d )
            deallocate(tprs_sde_s )
            deallocate(tprg_gde_d )
            deallocate(tprg_gde_s )
            deallocate(tpri_iha   )
            deallocate(tpri_wfz   )
            deallocate(tpri_rfz   )
            deallocate(tprg_rfz   )
            ...
            deallocate(tprr_rci   )
            deallocate(tprg_rcg   )
            deallocate(tprw_vcd_c )
            deallocate(tprw_vcd_e )
            deallocate(tprr_sml   )
            deallocate(tprr_gml   )
            deallocate(tprr_rcg   )
            deallocate(tprr_rcs   )
