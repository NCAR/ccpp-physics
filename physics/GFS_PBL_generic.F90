...
!!
      subroutine GFS_PBL_generic_pre_run (im, levs, nvdiff, ntrac, rtg_ozone_index,      &
        ...
        imp_physics_nssl2m,imp_physics_nssl2mccn, ltaerosol, nssl_hail_on,  &
      ...
      logical, intent(in) :: cplchm, ltaerosol, nssl_hail_on
...
!!
      ...
      integer, intent(in) :: imp_physics, imp_physics_gfdl, imp_physics_thompson, imp_physics_wsm6
      integer, intent(in) :: imp_physics_zhao_carr, imp_physics_mg, imp_physics_fer_hires
      integer, intent(in) :: imp_physics_nssl2m, imp_physics_nssl2mccn, nssl_hail_on
