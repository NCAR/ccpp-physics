...
!> This module contains the CCPP-compliant flake scheme driver.
     module flake_driv
      ...
      public :: flake_driv_init, flake_driv_run, flake_driv_finalize

      contains

!> \section arg_table_flake_driv_init Argument Table
!! \htmlinclude flake_driv_init.html
!!
      subroutine flake_driv_init (errmsg, errflg)
      ...
      end subroutine flake_driv_init

!> \section arg_table_flake_driv_finalize Argument Table
!! \htmlinclude flake_driv_finalize.html
!!
      subroutine flake_driv_finalize (errmsg, errflg)
      ...
      end subroutine flake_driv_finalize

!> \section arg_table_flake_driv_run Argument Table
!! \htmlinclude flake_driv_run.html
!!
      SUBROUTINE flake_driv_run (                            &
! ---- Inputs
            im, ps, t1, q1, wind,                            &
            dlwflx, dswsfc, weasd, lakedepth,                &
            xlat, delt, zlvl, elev,                          &
            islmsk, flag_iter, yearlen, julian, imon,       &
! ---- in/outs
            snwdph, icedph, tsurf, fice, T_sfc, hflx, evap, &
            ustar_lak, qsfc, ch_lak, cm_lak, chh_lak, cmm_lak )     
...
IMPLICIT NONE
     ...
     &           snwdph, icedph, tsurf, t_sfc, hflx, evap, fice, ustar_lak, qsfc,   &
     &           ch_lak, cm_lak, chh_lak, cmm_lak           
...
!  --- ...  set flag for lake points
      ...
      do i = 1, im
        flag(i) = (islmsk(i) == 5 .and. lakedepth(i).gt.0.0) .and. flag_iter(i)
      enddo
...
!                h_snow(i)= 0.0
!           endif
           if(snwdph(i).gt.0.0 .or. icedph(i).gt.0.0) then
...
!
              ...
              if(icedph(i) .gt. 0.0 .or. snwdph(i) .gt. 0.0) then
                fice(i) = 1.0
              else
                fice(i) = 0.0
              endif
...
END SUBROUTINE flake_driv_run

!---------------------------------
      end module flake_driv
