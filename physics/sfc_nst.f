...
cc
      ...
      write (0,*) "DH DEBUG: IN im         = ", im
      write (0,*) "DH DEBUG: IN ps         = ", sum(ps          )
      write (0,*) "DH DEBUG: IN u1         = ", sum(u1          )
      write (0,*) "DH DEBUG: IN v1         = ", sum(v1          )
      write (0,*) "DH DEBUG: IN t1         = ", sum(t1          )
      write (0,*) "DH DEBUG: IN q1         = ", sum(q1          )
      write (0,*) "DH DEBUG: IN tref       = ", sum(tref        )
      write (0,*) "DH DEBUG: IN cm         = ", sum(cm          )
      write (0,*) "DH DEBUG: IN ch         = ", sum(ch          )
      write (0,*) "DH DEBUG: IN prsl1      = ", sum(prsl1       )
      write (0,*) "DH DEBUG: IN prslki     = ", sum(prslki      )
      write (0,*) "DH DEBUG: IN wet        = ", count(wet       )
      write (0,*) "DH DEBUG: IN xlon       = ", sum(xlon        )
      write (0,*) "DH DEBUG: IN sinlat     = ", sum(sinlat      )
      write (0,*) "DH DEBUG: IN stress     = ", sum(stress      )
      write (0,*) "DH DEBUG: IN sfcemis    = ", sum(sfcemis     )
      write (0,*) "DH DEBUG: IN dlwflx     = ", sum(dlwflx      )
      write (0,*) "DH DEBUG: IN sfcnsw     = ", sum(sfcnsw      )
      write (0,*) "DH DEBUG: IN rain       = ", sum(rain        )
      write (0,*) "DH DEBUG: IN timestep   = ", timestep
      write (0,*) "DH DEBUG: IN kdt        = ", kdt     
      write (0,*) "DH DEBUG: IN solhr      = ", solhr   
      write (0,*) "DH DEBUG: IN xcosz      = ", sum(xcosz       )
      write (0,*) "DH DEBUG: IN wind       = ", sum(wind        )
      write (0,*) "DH DEBUG: IN flag_iter  = ", count(flag_iter )
      write (0,*) "DH DEBUG: IN flag_guess = ", count(flag_guess)
      !write (0,*) "DH DEBUG: IN nstf_name  = ", (/ nstf_name1, nstf_name4, nstf_name5 /) 
      write (0,*) "DH DEBUG: IN lprnt      = ", lprnt
      write (0,*) "DH DEBUG: IN ipr        = ", ipr  
      write (0,*) "DH DEBUG: IN tskin      = ", sum(tskin       )
      write (0,*) "DH DEBUG: IN tsurf      = ", sum(tsurf       )
      write (0,*) "DH DEBUG: IN xt         = ", sum(xt          )
      write (0,*) "DH DEBUG: IN xs         = ", sum(xs          )
      write (0,*) "DH DEBUG: IN xu         = ", sum(xu          )
      write (0,*) "DH DEBUG: IN xv         = ", sum(xv          )
      write (0,*) "DH DEBUG: IN xz         = ", sum(xz          )
      write (0,*) "DH DEBUG: IN zm         = ", sum(zm          )
      write (0,*) "DH DEBUG: IN xtts       = ", sum(xtts        )
      write (0,*) "DH DEBUG: IN xzts       = ", sum(xzts        )
      write (0,*) "DH DEBUG: IN dt_cool    = ", sum(dt_cool     )
      write (0,*) "DH DEBUG: IN z_c        = ", sum(z_c         )
      write (0,*) "DH DEBUG: IN c_0        = ", sum(c_0         )
      write (0,*) "DH DEBUG: IN c_d        = ", sum(c_d         )
      write (0,*) "DH DEBUG: IN w_0        = ", sum(w_0         )
      write (0,*) "DH DEBUG: IN w_d        = ", sum(w_d         )
      write (0,*) "DH DEBUG: IN d_conv     = ", sum(d_conv      )
      write (0,*) "DH DEBUG: IN ifd        = ", sum(ifd         )
      write (0,*) "DH DEBUG: IN qrain      = ", sum(qrain       )
      write (0,*) "DH DEBUG: IN qsurf      = ", sum(qsurf       )
      write (0,*) "DH DEBUG: IN gflux      = ", sum(gflux       )
      write (0,*) "DH DEBUG: IN cmm        = ", sum(cmm         )
      write (0,*) "DH DEBUG: IN chh        = ", sum(chh         )
      write (0,*) "DH DEBUG: IN evap       = ", sum(evap        )
      write (0,*) "DH DEBUG: IN hflx       = ", sum(hflx        )
      write (0,*) "DH DEBUG: IN ep         = ", sum(ep          )
...
!     if (lprnt) print *,' tskin=',tskin(ipr)
      ...
      write (0,*) "DH DEBUG: OUT im         = ", im
      write (0,*) "DH DEBUG: OUT ps         = ", sum(ps          )
      write (0,*) "DH DEBUG: OUT u1         = ", sum(u1          )
      write (0,*) "DH DEBUG: OUT v1         = ", sum(v1          )
      write (0,*) "DH DEBUG: OUT t1         = ", sum(t1          )
      write (0,*) "DH DEBUG: OUT q1         = ", sum(q1          )
      write (0,*) "DH DEBUG: OUT tref       = ", sum(tref        )
      write (0,*) "DH DEBUG: OUT cm         = ", sum(cm          )
      write (0,*) "DH DEBUG: OUT ch         = ", sum(ch          )
      write (0,*) "DH DEBUG: OUT prsl1      = ", sum(prsl1       )
      write (0,*) "DH DEBUG: OUT prslki     = ", sum(prslki      )
      write (0,*) "DH DEBUG: OUT wet        = ", count(wet       )
      write (0,*) "DH DEBUG: OUT xlon       = ", sum(xlon        )
      write (0,*) "DH DEBUG: OUT sinlat     = ", sum(sinlat      )
      write (0,*) "DH DEBUG: OUT stress     = ", sum(stress      )
      write (0,*) "DH DEBUG: OUT sfcemis    = ", sum(sfcemis     )
      write (0,*) "DH DEBUG: OUT dlwflx     = ", sum(dlwflx      )
      write (0,*) "DH DEBUG: OUT sfcnsw     = ", sum(sfcnsw      )
      write (0,*) "DH DEBUG: OUT rain       = ", sum(rain        )
      write (0,*) "DH DEBUG: OUT timestep   = ", timestep
      write (0,*) "DH DEBUG: OUT kdt        = ", kdt     
      write (0,*) "DH DEBUG: OUT solhr      = ", solhr   
      write (0,*) "DH DEBUG: OUT xcosz      = ", sum(xcosz       )
      write (0,*) "DH DEBUG: OUT wind       = ", sum(wind        )
      write (0,*) "DH DEBUG: OUT flag_iter  = ", count(flag_iter )
      write (0,*) "DH DEBUG: OUT flag_guess = ", count(flag_guess)
      !write (0,*) "DH DEBUG: IN nstf_name  = ", (/ nstf_name1, nstf_name4, nstf_name5 /)
      write (0,*) "DH DEBUG: OUT lprnt      = ", lprnt
      write (0,*) "DH DEBUG: OUT ipr        = ", ipr  
      write (0,*) "DH DEBUG: OUT tskin      = ", sum(tskin       )
      write (0,*) "DH DEBUG: OUT tsurf      = ", sum(tsurf       )
      write (0,*) "DH DEBUG: OUT xt         = ", sum(xt          )
      write (0,*) "DH DEBUG: OUT xs         = ", sum(xs          )
      write (0,*) "DH DEBUG: OUT xu         = ", sum(xu          )
      write (0,*) "DH DEBUG: OUT xv         = ", sum(xv          )
      write (0,*) "DH DEBUG: OUT xz         = ", sum(xz          )
      write (0,*) "DH DEBUG: OUT zm         = ", sum(zm          )
      write (0,*) "DH DEBUG: OUT xtts       = ", sum(xtts        )
      write (0,*) "DH DEBUG: OUT xzts       = ", sum(xzts        )
      write (0,*) "DH DEBUG: OUT dt_cool    = ", sum(dt_cool     )
      write (0,*) "DH DEBUG: OUT z_c        = ", sum(z_c         )
      write (0,*) "DH DEBUG: OUT c_0        = ", sum(c_0         )
      write (0,*) "DH DEBUG: OUT c_d        = ", sum(c_d         )
      write (0,*) "DH DEBUG: OUT w_0        = ", sum(w_0         )
      write (0,*) "DH DEBUG: OUT w_d        = ", sum(w_d         )
      write (0,*) "DH DEBUG: OUT d_conv     = ", sum(d_conv      )
      write (0,*) "DH DEBUG: OUT ifd        = ", sum(ifd         )
      write (0,*) "DH DEBUG: OUT qrain      = ", sum(qrain       )
      write (0,*) "DH DEBUG: OUT qsurf      = ", sum(qsurf       )
      write (0,*) "DH DEBUG: OUT gflux      = ", sum(gflux       )
      write (0,*) "DH DEBUG: OUT cmm        = ", sum(cmm         )
      write (0,*) "DH DEBUG: OUT chh        = ", sum(chh         )
      write (0,*) "DH DEBUG: OUT evap       = ", sum(evap        )
      write (0,*) "DH DEBUG: OUT hflx       = ", sum(hflx        )
      write (0,*) "DH DEBUG: OUT ep         = ", sum(ep          )
