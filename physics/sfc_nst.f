...
!! | solhr          | forecast_hour_of_the_day                                                     | time in hours after 00z at the current timestep             | h             |    0 | real      | kind_phys | in     | F        |
...
!! | ffmm_ocn       | Monin_Obukhov_similarity_function_for_momentum_over_ocean         | Monin-Obukhov similarity function for momentum over ocean             | none          |    1 | real        | kind_phys | inout  | F        |
...
!! | ffhh_ocn       | Monin_Obukhov_similarity_function_for_heat_over_ocean             | Monin-Obukhov similarity function for heat over ocean                 | none          |    1 | real        | kind_phys | inout  | F        |
